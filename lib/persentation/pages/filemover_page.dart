...
class _FileMoverPageState extends State<FileMoverPage> {
  ...
  List<String> _parseFileNames() {
    ...
    return input
        ...
        .map((e) => e.endsWith(_selectedExtension) ? e : '$e$_selectedExtension')
        .toList();
  }
  ...
  Future<void> findAndMoveFiles() async {
    ...
    if (filesFromApi.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Mohon masukkan nama file terlebih dahulu')),
      );
      return;
    }
    ...
    try {
      ...
      final foundFiles = filesFromApi.where((targetFile) => 
        filesInSource.contains(targetFile)
      ).toList();

      final notFoundFiles = filesFromApi.where((targetFile) => 
        !filesInSource.contains(targetFile)
      ).toList();
    ...
    return showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
            ...
            child: Column(
              ...
              children: [
                ...
                if (notFoundFiles.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ...notFoundFiles.map((file) => Padding(
                    padding: const EdgeInsets.symmetric(vertical: 2),
                    child: Row(
                      children: [
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            dense: true,
                            leading: Icon(
                              willMove ? Icons.drive_file_move : Icons.insert_drive_file,
                              size: 16,
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                fontSize: 11,
                                fontWeight: willMove ? FontWeight.bold : FontWeight.normal,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: foundFiles.isEmpty ? null : () => Navigator.pop(context, true),
  ...
  Future<void> _processMoving(String sourcePath, String destPath, List<String> filesFromApi) async {
    int successCount = 0;
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: "SWV00201, SWV00032, SWV00049 (pisahkan dengan koma)",
...
class _HistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasErrors = history.failedFiles.isNotEmpty || history.notFoundFiles.isNotEmpty;
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    if (history.failedFiles.isNotEmpty) ...[
                      ...
                      ...history.failedFiles.map((file) => Padding(
                    ...
                    if (history.notFoundFiles.isNotEmpty) ...[
                      const Row(
                        children: [
                          Icon(Icons.search_off, size: 14, color: Colors.orange),
                          SizedBox(width: 4),
                          Text(
                      ...
                      const SizedBox(height: 4),
                      ...history.notFoundFiles.map((file) => Padding(
                        padding: const EdgeInsets.only(left: 18, bottom: 4),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
